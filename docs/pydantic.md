...
1. `pydantic_lab/models.py`
2. `pydantic_lab/service.py`
3. `pydantic_lab/settings.py`
4. `pydantic_lab/main.py`
5. `tests/test_pydantic_lab.py`
6. `exercises/04_pydantic.py`
